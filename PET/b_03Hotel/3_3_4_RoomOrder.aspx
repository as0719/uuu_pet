...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Page.IsPostBack == false)
        {
            ...
            LbHeight.Text = room.RoomHeight;
            LbWidth.Text = room.RoomWidth;
            LbDepth.Text = room.RoomDepth;
        }
    }
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="forms-sample">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-1"></div>
                                    <label for="BodyHolder_LbHeight" class="col-sm-3 col-form-label">房間長度</label>
                                    <asp:Label ID="LbHeight" runat="server" Text=""></asp:Label>
                                    <%--<asp:TextBox ID="txtHeight" CssClass="form-control" placeholder="長度" runat="server"></asp:TextBox>--%>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-1"></div>
                                    <label for="BodyHolder_LbWidth" class="col-sm-3 col-form-label">房間寬度</label>
                                    <asp:Label ID="LbWidth" runat="server" Text=""></asp:Label>
                                    <%--<asp:TextBox ID="txtWidth" CssClass="form-control" placeholder="寬度" runat="server"></asp:TextBox>--%>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-1"></div>
                                    <label for="BodyHolder_LbDepth" class="col-sm-3 col-form-label">房間深度</label>
                                    <asp:Label ID="LbDepth" runat="server" Text=""></asp:Label>
                                    <%--<asp:TextBox ID="txtDepth" CssClass="form-control" placeholder="深度" runat="server"></asp:TextBox>--%>
                                </div>                          
                                <div class="form-group row">
                                    <div class="col-sm-1"></div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8 form-group">
                                        <asp:DropDownList ID="DrpStatus" CssClass="form-control js-example-basic-single w-50" runat="server" AppendDataBoundItems="True" DataSourceID="SqlDataSource1" DataTextField="Status" DataValueField="Status"></asp:DropDownList>
