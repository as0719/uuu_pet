    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            if (Page.IsPostBack == false)
            {
                ...
                //{
                //    RoomUtility utility = new RoomUtility();
                //    Session["Members"] = utility.GetMember();
                //}

                LbRoomType.Text = room.RoomType;
                //LbTotal.Text = room.Price.ToString();
                //HiddenField2.Value = room.Price.ToString();
            }
        }
...
<asp:Content ID="Content1" ContentPlaceHolderID="CssHolder" runat="Server">
    ...
    <style>
        body{
            background: url("/f_img/freestocks-t8SxccV0Agw-unsplash.jpg") center bottom;
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyHolder" runat="Server">
    <%--<div style="background: url(../f_img/freestocks-t8SxccV0Agw-unsplash.jpg) repeat-y; background-size: cover;">--%>
