                            ...
                            <div class="forms-sample">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-2">                                        
                                        ...
                                        <button type="button" onClick="javascript:window.location.href='/b_05Class/5_1_ClassInfo.aspx'" class="btn btn-light">取消</button>
                                        <input type="button" class="btn btn-secondary" onclick="setDemo()" value="demo" />
                                    </div>
                                </div>
    ...
    <script src="/b_forBackend/js/sweetalert2.js"></script>
     <script>
        ...
        $(function () {
         ...
         function setDemo() {
             $("#BodyHolder_txtCourseName").val("貓行為專業課基礎假日班");
             $("#BodyHolder_txtIntroduction").val("想瞭解自己的貓咪嗎？想更懂貓嗎？希望自己的貓咪真正快樂嗎？");
             $("#BodyHolder_txtStartDate").val("2022/10/29");
             $("#BodyHolder_txtStartTime").val("13:00");
             $("#BodyHolder_txtEndTime").val("17:00");
             $("#BodyHolder_txtMaxPeople").val("5");
             $("#BodyHolder_txtMaxPet").val("5");
         }
     </script>
</asp:Content>
